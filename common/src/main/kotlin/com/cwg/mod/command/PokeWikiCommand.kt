...
import com.cwg.mod.util.player
...
object PokeWikiCommand {
    ...
    val ALIASES_OTHER : List<String> = ALIASES.map { it -> "${it}other"; }
    ...
    fun execute(context: CommandContext<CommandSourceStack>, player: ServerPlayer): Int {
        try {
            ...
            if (!context.source.isPlayer) {
                ...
                PokeWikiGui.open(pokemonSpecies, player)
            }
