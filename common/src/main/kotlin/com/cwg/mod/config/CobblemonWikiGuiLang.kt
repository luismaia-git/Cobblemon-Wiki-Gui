...
class CobblemonWikiGuiLang {
    ...
    var pokeWikiTitle: String = "Cobblemon Wiki"
    var pokeWikiTitleWithForm: String = "Cobblemon Wiki - %species% (%form%)"
    var githubIssuesButtonName: String = "Report an Issue"
    var githubIssuesButtonLore: String = "Click to get a link to report bugs or suggestions on GitHub"
    var githubIssuesLinkText: String = "Click here to open the GitHub issues page"
